...
ActiveRecord::Schema[7.0].define(version: 2022_08_31_213851) do
  ...
  create_table "alt_texts", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["alt_id"], name: "index_alt_texts_on_alt_id"
    t.index ["user_id"], name: "index_alt_texts_on_user_id"
  end
