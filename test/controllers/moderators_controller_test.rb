...
class ModeratorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create moderator" do
    assert_difference("Moderator.count") do
      post moderators_url, params: { moderator: { contributor: @moderator.contributor, description: @moderator.description, flag: @moderator.flag, moderator: @moderator.moderator, super_admin: @moderator.super_admin, title: @moderator.title, user_id: @moderator.user_id } }
    end
  ...
  test "should update moderator" do
    patch moderator_url(@moderator), params: { moderator: { contributor: @moderator.contributor, description: @moderator.description, flag: @moderator.flag, moderator: @moderator.moderator, super_admin: @moderator.super_admin, title: @moderator.title, user_id: @moderator.user_id } }
