...
class AboutsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create about" do
    assert_difference("About.count") do
      post abouts_url, params: { about: { body: @about.body, description: @about.description, seo: @about.seo } }
    end
  ...
  test "should update about" do
    patch about_url(@about), params: { about: { body: @about.body, description: @about.description, seo: @about.seo } }
