...
class DocumentationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create documentation" do
    assert_difference("Documentation.count") do
      post documentations_url, params: { documentation: { body: @documentation.body, description: @documentation.description, seo: @documentation.seo } }
    end
  ...
  test "should update documentation" do
    patch documentation_url(@documentation), params: { documentation: { body: @documentation.body, description: @documentation.description, seo: @documentation.seo } }
